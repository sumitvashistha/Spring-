...
import com.areyes1.jgc.junit.spring.bcus.MyRunner;
...
public class JUnitSpringExample {
    ...
    private static final Logger LOG
            = LoggerFactory.getLogger(JUnitSpringExample.class);
    ...
    public void testSampleServiceGetAccountCode() {
        ...
        assertTrue(sampleService.getOrderStringCode().contains("Code1:"));
    }
